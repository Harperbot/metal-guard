...
**Current version: v0.11.1** — see [CHANGELOG.md](CHANGELOG.md) for release history and per-feature rationale.
...
`pip install "git+https://github.com/Harperbot/metal-guard.git@v0.11.1"` or
